...
public class LightsTests {
    ...
    public void trianglesDirectional() {
        ...
        scene.addGeometries(
                new Triangle(
                        new Point3D(-150, 150, 150), new Point3D(150, 150, 150), new Point3D(75, -75, 150), Color.BLACK,new Material(0.8, 0.2, 300)),
                new Triangle(
                        new Point3D(-150, 150, 150), new Point3D(-70, -70, 50), new Point3D(75, -75, 150),Color.BLACK, new Material(0.8, 0.2, 300)));
    ...
    public void trianglesPoint() {
        ...
        scene.addGeometries(
                new Triangle(
                        new Point3D(-150, 150, 150), new Point3D(150, 150, 150), new Point3D(75, -75, 150),Color.BLACK, new Material(0.5, 0.5, 300)),
                new Triangle(
                        new Point3D(-150, 150, 150), new Point3D(-70, -70, 50), new Point3D(75, -75, 150),Color.BLACK, new Material(0.5, 0.5, 300)));
    ...
    public void sphereMultiLight() {
        ...
        new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
        		1, 0.00001, 0.00000001, new Vector(1, 2, 2)));
    ...
    public void trianglesMultiLight() {
        ...
        ,new SpotLight(new Color(500, 250, 250), new Point3D(-120, 90, 130), 1, 0.0001, 0.000005, new Vector(2, -2, -1))
        );
