...
public class RenderTests {
    ...
    public void basicRenderMultiColorTest() {
        ...
        scene.addGeometries(
                new Triangle(new Point3D(100, 0, 100), new Point3D(0, 100, 100), new Point3D(100, 100, 100), new Color(java.awt.Color.BLUE)),      // lower right
                new Triangle(
                        new Point3D(100, 0, 100), new Point3D(0, -100, 100), new Point3D(100, -100, 100)),    // upper right
                new Triangle(new Point3D(-100, 0, 100), new Point3D(0, 100, 100), new Point3D(-100, 100, 100), new Color(java.awt.Color.RED)),    // lower left
                new Triangle(new Point3D(-100, 0, 100), new Point3D(0, -100, 100), new Point3D(-100, -100, 100),
                		new Color(java.awt.Color.GREEN))); // upper left
